...
A grande vantagem da arquitetura deste projeto é que ele roda nativamente em qualquer *browser* moderno. Não há necessidade de configurar ambientes (como Node.js, Apache ou bancos de dados).
...
```text
/consultaReservas
    ├── index.html    - Ponto de entrada, contendo o esqueleto da interface e chamadas das bibliotecas;
    ├── style.css     - Arquivo responsável por toda a interface gráfica e formatação de impressão;
    ├── script.js     - Contém o dicionário de Unidades Orçamentárias, lógica e as regras de filtragem;
    ├── logo.png      - Logotipo do cabeçalho e relatórios oficiais;
